...
public class CustomerPanel extends javax.swing.JPanel {
    ...
    public void showList(ArrayList<Customer> list) {
        ...
        for (Customer ctmDTO : list) {
            customerTable.addRow(new Object[]{
                ctmDTO.getCustomerId(), 
                ctmDTO.getCustomerFirstname(), 
                ctmDTO.getCustomerLastname(), 
                ctmDTO.getCustomerPoint(), // Thay CustomerAddress bằng CustomerPoint
                ctmDTO.getCustomerPhone()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        jTableCustomer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã khách hàng", "Họ", "Tên", "Điểm", "Số điện thoại" 
            }
        ) {
    ...
    private void textFieldCustomerFirstnameActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void textFieldCustomerPhoneActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void textFieldCustomerLastnameActionPerformed(java.awt.event.ActionEvent evt) {
    }
    ...
    private void textFieldCustomerFirstnameKeyReleased(java.awt.event.KeyEvent evt) {
    ...
    private void textFieldCustomerLastnameKeyReleased(java.awt.event.KeyEvent evt) {
    ...
    private void textFieldCustomerPhoneKeyReleased(java.awt.event.KeyEvent evt) {
    }

    private void textFieldCustomerPhoneFocusLost(java.awt.event.FocusEvent evt) {
    ...
    private void jTableCustomerKeyPressed(java.awt.event.KeyEvent evt) {
        selectedRowIndex = jTableCustomer.getSelectedRow();
