...
public class DiscountPanel extends javax.swing.JPanel {
    ...
    public void showList(ArrayList<Discount> list) {
        ...
        for (Discount dcDTO : list) {
            discountTable.addRow(new Object[]{dcDTO.getDiscountId(), dcDTO.getDiscountName(), dcDTO.getDiscountBegin(), dcDTO.getDiscountEnd(), dcDTO.getDiscountPercnt()});
        }
    }
