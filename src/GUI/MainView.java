...
public class MainView extends JFrame {
    ...
    private void setupMenuPanel() {
        ...
        JButton categoryButton = createNavigationButton("Loại sản phẩm", "\uD83D\uDCC1");
        ...
        JButton productDetailButton = createNavigationButton("Chi tiết sản phẩm", "\uD83D\uDDD3");
        productDetailButton.addActionListener(e -> showProductDetailPanel());
        navigationPanel.add(productDetailButton);
        // Thống kê sản phẩm
