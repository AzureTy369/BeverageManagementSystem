    ...
    public static ArrayList<Customer> search(String info) {
        ...
        try {
            ...
            if (info != null && !info.isEmpty()) {
                query = "SELECT * FROM customer WHERE customerID LIKE ? OR CONCAT(firstname, ' ', lastname) LIKE ? " +
                       "OR address LIKE ? OR phone LIKE ? OR customerPoint LIKE ? OR customerDate LIKE ?";
                pstmt = connection.prepareStatement(query);
    ...
    public static void setAllCustomers(ArrayList<Customer> list) {
        ...
        try {
            ...
            for (Customer customer : list) {
                ...
                pstmt.setString(6, customer.getCustomerPoint());
                pstmt.setString(7, customer.getCustomerDate());
