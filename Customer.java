...
public class Customer {
	 private String customerId;
		...
		public void setAll (String id , String first , String last , String add,String phone ) {
		...
		public Customer(String customerId, String customerFirstname , String customerLastname, String cusAdd,String customerPhone) {
			super();
			this.customerId = customerId;
			this.customerFirstname = customerFirstname;
			this.customerPhone = customerPhone;
